...
function Settings() {
  return (
    <div className="p-0 pb-24 max-w-xl mx-auto">
      <header className="sticky top-0 z-10 bg-background px-4 py-3 border-b border-border flex flex-row items-center gap-3">
        <Link to="/" className="rounded-md px-2 py-1 hover:bg-muted text-sm">
          ← Home
        </Link>

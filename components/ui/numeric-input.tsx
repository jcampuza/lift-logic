...
interface NumericInputProps
  extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "onChange" | "value" | "type" | "step"> {
  ...
  (
    ...
    const handleInputChange = useCallback(
      (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Parse the number
        let numericValue = allowDecimals ? parseFloat(inputValue) : parseInt(inputValue, 10);
    ...
    const handleKeyDown = useCallback(
      (e: React.KeyboardEvent<HTMLInputElement>) => {
        ...
        if ((e.ctrlKey === true || e.metaKey === true) && ['a', 'c', 'v', 'x'].includes(e.key.toLowerCase())) {
          return;
        }
